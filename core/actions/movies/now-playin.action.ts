...
import { type OptionsRequest } from "@/core/infrastucture/interfaces/request-movies-option.interface";
import { MovieMapper } from "@/core/infrastucture/mappers/movie.mapper";


export const nowPlayingAction = async ({page = 1 , limit = 10}: OptionsRequest) => {
    try {
